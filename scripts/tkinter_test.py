...
motorT2 = singleMotorControl(window, "motorT2", 'e', 'd')
motorR2 = singleMotorControl(window, "motorR2", 'r', 'f')
motorT3 = singleMotorControl(window, "motorT3", 't', 'g')
motorR3 = singleMotorControl(window, "motorT2", 'y', 'h')
