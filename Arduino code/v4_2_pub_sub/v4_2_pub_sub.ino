...
Motor_stepper R1(13,12, -45,  45, radPerMinorStep, 4.0, "vel_motorR1", "pos_motorR1");
Motor_stepper T1( 9, 8,-180, 180, radPerMinorStep, 4.0, "vel_motorT1", "pos_motorT1");
Motor_stepper T2(11,10,-180, 180, radPerMinorStep, 4.0, "vel_motorT2", "pos_motorT2");
Motor_stepper R2( 7, 6,-180, 180, radPerMinorStep, 4.0, "vel_motorR2", "pos_motorR2");
